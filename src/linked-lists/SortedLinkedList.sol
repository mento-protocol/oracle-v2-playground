...
library SortedLinkedList {
     ...
     * @return lesserKeyKeys The correct lesserKey keys.
     * @return greaterKeyKeys The correct greaterKey keys.
     */
    function getLesserAndGreater(
        ...
        bytes32 lesserKey,
        bytes32 greaterKey
    ) private view returns (bytes32 lesserKeyKeys, bytes32 greaterKeyKeys) {
